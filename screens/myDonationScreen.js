...
export default class MyDonations extends React.Component{
   ...
   componentWillUnmount(){
    this.requestRef;
      ...
      getAllDonations =()=>{
        this.requestRef = db.collection("donations").where("donor_id" ,'==', this.state.donorId)
        .onSnapshot((snapshot)=>{
          var allDonations = []
      ...
      sendNotification=(bookDetails, requestStatus)=>{
        ...
        db.collection('notification').where('request_id',"==",requestId).where('donor_id','==',donorId).get().then((snapshot)=>{
            snapshot.forEach((doc)=>{
                var message = "";
